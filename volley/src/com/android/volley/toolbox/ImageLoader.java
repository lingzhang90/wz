...
public class ImageLoader {
	...
	public static ImageListener getImageListener(final ImageView view,
		...
		return new ImageListener() {
			...
			public void onErrorResponse(VolleyError error) {
				...
				if (loadImageCompleteListener != null) {
					loadImageCompleteListener.loadComplete();
				}
			}
	...
	public ImageContainer get(String requestUrl, ImageListener imageListener,
		...
		if (onNeedSetCookieListener != null) {
			onNeedSetCookieListener.setcookie();
		}
	...
	public ImageContainer getSpecialBitmap(String requestUrl,
	...
	public interface OnNeedSetCookieListener {
		public void setcookie();
	}

	private OnNeedSetCookieListener onNeedSetCookieListener;

	public void setOnNeedSetCookieListener(
			OnNeedSetCookieListener onNeedSetCookieListener) {
		this.onNeedSetCookieListener = onNeedSetCookieListener;
	}
	 ...
	 * 还是很局限的监听器，别乱用
	 * 
	 * @param onLoadImageCompleteListener
	 */
	public static void setOnLoadImageCompleteListener(
			OnLoadImageCompleteListener onLoadImageCompleteListener) {
		loadImageCompleteListener = onLoadImageCompleteListener;
	}

	private static OnLoadImageCompleteListener loadImageCompleteListener;
}
