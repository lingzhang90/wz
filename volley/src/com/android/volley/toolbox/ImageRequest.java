...
public class ImageRequest extends Request<Bitmap> {
	...
	protected Response<Bitmap> parseNetworkResponse(NetworkResponse response) {
		...
		synchronized (sDecodeLock) {
			try {
				if (cookieGetListener != null) {
					cookieGetListener.getCookie(response);
				}
	...
	public interface OnCookieGetListener {
		public void getCookie(NetworkResponse response);
	}

	private static OnCookieGetListener cookieGetListener;

	public static void setOnCookieGetListener(
			OnCookieGetListener onCookieGetListener) {
		cookieGetListener = onCookieGetListener;
	}
}
